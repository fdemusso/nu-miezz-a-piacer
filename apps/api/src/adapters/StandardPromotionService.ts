...
export class StandardPromotionService implements IPromotionService {
  async getAvailablePromotions(customer: Customer): Promise<Promotion[]> { return [] }

  async applyPromotion(customer: Customer, estimate: CostEstimate, promotionCode: string): Promise<CostEstimate> { return {} as CostEstimate }
}
